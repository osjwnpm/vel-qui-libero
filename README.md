# @osjwnpm/vel-qui-libero

![npm (scoped)](https://img.shields.io/npm/v/@osjwnpm/vel-qui-libero)

`@osjwnpm/vel-qui-libero` is a powerful framework that allows you to build and manage server-rendered React applications with ease. It comes with built-in support for server-side state management, authentication, and more.
...
```tsx
import { Scopes, useState, clientKey } from '@osjwnpm/vel-qui-libero';
...
![screenshot](https://raw.githubusercontent.com/osjwnpm/vel-qui-libero-docs-md/master/images/screenshot.jpg)
